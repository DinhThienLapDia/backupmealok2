    ...
    module Helper
      ...
      def community_params(params, marketplace_name, locale)
        ident = available_ident_based_on(marketplace_name)
        {
          ...
          available_currencies: available_currencies_based_on(params[:marketplace_country].or_else("vi")),
      ...
      def available_currencies_based_on(country_code)
        Maybe(MarketplaceService::AvailableCurrencies::COUNTRY_CURRENCIES[country_code.upcase]).or_else("VND")
      end
